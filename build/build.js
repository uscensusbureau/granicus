...
let _ = require("lodash")(function () {
  // Create the connector object
  let account = "11723";
  let myConnector = tableau.makeConnector(); // Define the schema
  ...
  myConnector.getData = function (table, doneCallback) {
    ...
    let new_date = year + "-" + month + "-" + day; // Week ago date
    ...
    let wks_1_date = wks_1_year + "-" + wks_1_month + "-" + wks_1_day; // 2 Weeks ago date
    ...
    let wks_2_date = wks_2_year + "-" + wks_2_month + "-" + wks_2_day; // 3 weeks ago date
    ...
    let wks_3_date = wks_3_year + "-" + wks_3_month + "-" + wks_3_day; // month ago date
    ...
    let bulletin_summary_3wks = base_url + `reports/bulletins/summary?start_date=${wks_3_date}&end_date=${wks_2_date}`; // let subcriber_summary_1wk = base_url + `reports/subscriber_activity/summary?start_date=${wks_1_date}&end_date=${new_date}`
    // let subcriber_summary_2wks = base_url + `reports/subscriber_activity/summary?start_date=${wks_2_date}&end_date=${new_date}`

    let call_list = [bulletin_summary_1wk, bulletin_summary_2wks, bulletin_summary_3wks];
